...
var routes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-LRPN2ECA.js").then((m) => m.MsSimulatorPage)
  }, false ? { \u0275entryName: "src/app/design-system/pages/ms-simulator-page/ms-simulator-page.ts" } : {})
];

// src/app/interceptors/cors.interceptor.ts
var CorsInterceptor = class _CorsInterceptor {
  intercept(req, next) {
  ...
  static \u0275fac = function CorsInterceptor_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CorsInterceptor)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _CorsInterceptor, factory: _CorsInterceptor.\u0275fac });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CorsInterceptor, [{
    type: Injectable
  }], null, null);
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", imports: [RouterOutlet, MsSimulatorPage], template: "<router-outlet></router-outlet>" }]
  }], null, null);
})();
(() => {
